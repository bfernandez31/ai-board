...
- **`${CLAUDE_PLUGIN_ROOT:-.}/.ai-board/memory/constitution.md`**: Project principles, standards, and guidelines - MUST READ on every stage
...
1. **READ CONSTITUTION**: Use Read tool to read `${CLAUDE_PLUGIN_ROOT:-.}/.ai-board/memory/constitution.md` (project principles and standards)
...
**Process for VERIFY**:
1. **READ CONSTITUTION**: Use Read tool to read `${CLAUDE_PLUGIN_ROOT:-.}/.ai-board/memory/constitution.md`
