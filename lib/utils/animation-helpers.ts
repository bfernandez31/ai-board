...
export const WORKFLOW_STAGES: readonly WorkflowStage[] = [
  ...
  },
  {
    ...
    headerBgColor: 'bg-ctp-peach/30',
    headerBorderColor: 'border-ctp-peach/40',
    textColor: 'text-ctp-peach',
    borderColor: 'border-ctp-peach/40',
    badgeBgColor: 'bg-ctp-peach/70',
    badgeTextColor: 'text-zinc-50',
  },
  {
    index: 4,
    ...
    label: 'VERIFY',
    color: 'pink',
    bgColor: 'bg-ctp-rosewater/10',
    headerBgColor: 'bg-ctp-rosewater/30',
    headerBorderColor: 'border-ctp-rosewater/40',
    textColor: 'text-ctp-rosewater',
    borderColor: 'border-ctp-rosewater/40',
    badgeBgColor: 'bg-ctp-rosewater/70',
    badgeTextColor: 'text-zinc-50',
  },
  {
    index: 5,
