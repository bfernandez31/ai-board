...
## Active Technologies
- TypeScript 5.x (strict mode), Node.js 18.17+ or 20.x+ + Next.js 15, React 18, TailwindCSS 3.x, Playwrigh (001-initialize-the-ai)
- TypeScript 5.6 (strict mode), Node.js 20.x + Next.js 15 (App Router), React 18, TailwindCSS 3.4, Prisma (to be added), shadcn/ui (to be added) (002-create-a-basic)
