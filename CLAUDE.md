...
- **State**: TanStack Query v5.95.2, client-side polling (2s jobs, 10s comments, 15s notifications, 15s analytics, 15s usage, 15s admin-insights while RUNNING, 30s admin-home with stale-while-revalidate)
