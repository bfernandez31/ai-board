...
- JobLog: One per job (separate table), 30-day retention, auto-pruned via `POST /api/cron/prune-logs`; `Job.logStatus` tracks NONE/AVAILABLE/PRUNED; log processing in `lib/logs/`
