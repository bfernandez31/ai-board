      ...
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data}>
          ...
          <Tooltip
            ...
            content={renderChartTooltip<JobTrendPoint>((point) => ({
              title: point.d,
              rows: [
                { label: 'Completed', value: point.completed, color: 'hsl(var(--chart-2))' },
                { label: 'Failed', value: point.failed, color: 'hsl(var(--chart-3))' },
              ],
            }))}
          />
