...
const WORKFLOW_DIFFERENTIATORS = [
...
function renderWorkflowSteps(): React.JSX.Element[] {
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-start">
            <div className="flex flex-col gap-8">{renderWorkflowSteps()}</div>
            ...
            <aside className="rounded-3xl border border-border bg-background/90 p-6 shadow-sm">
              ...
              <ul className="mt-5 space-y-4">
                {WORKFLOW_DIFFERENTIATORS.map((item) => (
          ...
          <div className="mt-10 flex flex-col gap-8 lg:hidden">{renderWorkflowSteps()}</div>
        </div>
      </div>
    </section>
  );
