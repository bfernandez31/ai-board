...
- **`${CLAUDE_PLUGIN_ROOT:-./.claude-plugin}/memory/constitution.md`**: Project principles, standards, and guidelines - MUST READ on every stage
...
1. **READ CONSTITUTION**: Use Read tool to read `${CLAUDE_PLUGIN_ROOT:-./.claude-plugin}/memory/constitution.md` (project principles and standards)
