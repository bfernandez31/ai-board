export const queryKeys = {
  projects: {
    ...
    prDiff: (projectId: number, ticketId: number) =>
      ['projects', projectId, 'tickets', ticketId, 'pr-diff'] as const,
  },
  ...
  calibration: {
    dashboard: (projectId: number) =>
      ['calibration', 'dashboard', projectId] as const,
  },
  ...
  health: {
    ...
    scan: (projectId: number, moduleType: string | null, scanId: number | null) =>
      ['health', projectId, 'scan', moduleType, scanId] as const,
