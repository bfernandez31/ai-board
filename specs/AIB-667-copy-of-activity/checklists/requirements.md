...
- AUTO policy was invoked; low confidence (0.3) triggered CONSERVATIVE fallback. All auto-resolved decisions are documented in the spec's Auto-Resolved Decisions section with rationale and reviewer notes.
