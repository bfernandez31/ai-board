...
- [ ] T013 [P] [US1] Add Google credential fields to credential form in `/components/settings/credentials-form.tsx`
- [ ] T014 [P] [US1] Implement Google credential validation in `/lib/credentials.ts`
