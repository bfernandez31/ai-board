...
- Model ID - resolved from ticket/project per-stage config or the effective agent's global fallback (see Per-Stage Model Selection above); supported for Claude and Codex, omitted for other agents
