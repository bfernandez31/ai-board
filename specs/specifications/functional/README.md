...
Describes the Health Dashboard page, which provides a global health score (0–100) aggregated from up to 5 modules, on-demand scan triggering, and real-time scan status updates.

**Key Topics**:
- Global health score calculation (weighted average of 5 contributing modules)
- Five module cards: Security, Compliance, Tests, Spec Sync, Quality Gate
