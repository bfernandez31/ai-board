...
**Usage**:
- Used by `POST /api/projects/:projectId/docs/edit` for validating document edit requests
...
- **MERGE_CONFLICT**: Concurrent edit detected
- **NETWORK_ERROR**: GitHub API or network failure
