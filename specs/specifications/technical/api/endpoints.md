...
Comparison endpoints provide access to ticket comparison reports generated by the `/compare` AI-BOARD command. Reports are stored as markdown files in `specs/{branch}/comparisons/` directory.
...
env:
  ...
  # Batch log exports — flush once at process shutdown instead of per-request
