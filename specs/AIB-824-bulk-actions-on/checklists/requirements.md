...
- Validation iteration 1: 18/18 items passing.
- AUTO policy scored `+1` from neutral user-facing context, so the spec recorded a low-confidence fallback to CONSERVATIVE.
