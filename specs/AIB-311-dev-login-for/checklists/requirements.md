...
- FR-003 mentions "timing-safe comparison" which borders on implementation detail but is a security requirement that must be stated at the spec level to prevent insecure implementations.
