# Quick Implementation: #AIB-44 Add ticketKey on project card
On the project card should show the ticketKey, before the ticket title
...
**Feature Branch**: `078-aib-44-add`
**Created**: 2025-11-02
**Mode**: Quick Implementation (bypassing formal specification)

## Description

#AIB-44 Add ticketKey on project card
On the project card should show the ticketKey, before the ticket title
#ticketKey - ticketTitle
 IMPORTANT: never prompt me; you must do the full implementation, never run the full test suite, only impacted tests
