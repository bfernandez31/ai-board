# Specification Quality Checklist: Project Config in DB + Dynamic Workflow Dispatch
...
- 4 auto-resolved decisions documented with CONSERVATIVE fallback rationale.
- Effective policy: CONSERVATIVE (AUTO fallback due to low confidence score of 0.3).
