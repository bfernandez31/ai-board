...
- PRAGMATIC policy applied via AUTO with High confidence (0.9) — no fallbacks triggered.
- Python/Cargo runtime support explicitly scoped out for soft launch (Decision 2).
