# Specification Quality Checklist: Auto-transition mode on full-workflow tickets
...
- Two CONSERVATIVE fallbacks are documented in Auto-Resolved Decisions (toggle authorization scope, failure notification channel) — reviewers should validate these before `/ai-board.plan`.
